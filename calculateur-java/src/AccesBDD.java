public interface AccesBDD {
    ...
    static final String URL_BASE_DE_DONNEES = "jdbc:postgresql://XXX";
    static final String UTILISATEUR_BASE_DE_DONNEES = "XXX";
    static final String MOT_DE_PASSE_BASE_DE_DONNEES = "XXX";
    */
